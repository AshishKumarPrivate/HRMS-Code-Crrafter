...
class AddCompanyPolicyScreen extends StatefulWidget {
  const AddCompanyPolicyScreen({Key? key}) : super(key: key);

  @override
  State<AddCompanyPolicyScreen> createState() => _AddCompanyPolicyScreenState();
}

class _AddCompanyPolicyScreenState extends State<AddCompanyPolicyScreen> {
  ...
  Future<void> handleSubmit() async {
    ...
    policyProvider.addPolicy(context, requestBodyAddPolicy);
  }
