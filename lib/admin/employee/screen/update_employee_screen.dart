...
import '../model/employee_list_detail_model.dart';
...
class _UpdateEmployeeScreenState extends State<UpdateEmployeeScreen> {
  ...
  Future<void> _loadEmployeeData() async {
    storedEmployee = await StorageHelper().getEmployeeData();
    if (storedEmployee != null) {
      nameController.text = storedEmployee!.name ?? '';
      ...
      selectedGender = storedEmployee!.gender ?? 'Male';
      selectedMaritalStatus = storedEmployee!.maritalStatus ?? 'Single';
      setState(() {});
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: DefaultCommonAppBar(
        activityName: "Update Employee Details",
