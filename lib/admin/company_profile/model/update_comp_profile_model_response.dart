class UpdateCompanyOverviewModelResponse {
  bool? success;
  String? message;
  Data? data;

  UpdateCompanyOverviewModelResponse({this.success, this.message, this.data});

  UpdateCompanyOverviewModelResponse.fromJson(Map<String, dynamic> json) {
