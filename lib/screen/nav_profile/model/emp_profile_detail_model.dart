class EmpProfileDetailModelResponse {
  bool? success;
  String? message;
  Data? data;

  EmpProfileDetailModelResponse({this.success, this.message, this.data});

  EmpProfileDetailModelResponse.fromJson(Map<String, dynamic> json) {
