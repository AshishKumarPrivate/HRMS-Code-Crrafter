class UserAndAdminLoginModelResponse {
  bool? success;
  String? message;
  Data? data;
  EmployeeeData? employeeeData;

  UserAndAdminLoginModelResponse(
      {this.success, this.message, this.data, this.employeeeData});

  UserAndAdminLoginModelResponse.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    message = json['message'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    employeeeData = json['employeeeData'] != null
        ? new EmployeeeData.fromJson(json['employeeeData'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.employeeeData != null) {
      data['employeeeData'] = this.employeeeData!.toJson();
    }
    return data;
  }
}
